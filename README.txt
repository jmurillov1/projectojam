...
a persistence unit "coopjamPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "coopjam\pom.xml":
...
artifact ("coopjam.war") is already built. You can build
